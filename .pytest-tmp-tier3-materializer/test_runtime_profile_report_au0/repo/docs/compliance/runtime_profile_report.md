...
- Message: Validated runtime manifests are missing or failing for the base application-factory environments: base@py3.11, base@py3.12, base@py3.10

## Surface Probe

- Executed: `True`
- Passed: `False`
- Message: Validated runtime manifests are missing or failing for the base surface-probe environments: base@py3.11, base@py3.12, base@py3.10
- Endpoint count: `4`
- Passed endpoints: `4`
- Failed endpoints: `0`
