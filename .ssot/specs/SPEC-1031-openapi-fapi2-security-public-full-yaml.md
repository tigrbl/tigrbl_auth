# Repo spec: specs/openapi/profiles/fapi2-security/tigrbl_auth.public.openapi.yaml
  ...
  schemas:
    ...
    TokenResponse:
      ...
      properties:
        ...
        token_type:
          type: string
          description: Bearer for unconstrained or mTLS-bound tokens; DPoP for proof-of-possession
            tokens.
        expires_in:
          type: integer
        refresh_token:
