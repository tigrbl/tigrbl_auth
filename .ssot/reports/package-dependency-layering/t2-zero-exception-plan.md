...
uv run pytest tests/packages/tigrbl-auth-api-public tests/packages/tigrbl-auth-api-resource-validation tests/packages/tigrbl-auth-api-platform-admin tests/packages/tigrbl-auth-api-tenant-admin tests/packages/tigrbl-auth-api-developer tests/packages/tigrbl-auth-api-my-account
```
