...
- Message: Application factory materialized successfully with 18 active routes and 24 active targets.
...
- Serve check message: Application factory materialized successfully with 19 active routes and 24 active targets.
