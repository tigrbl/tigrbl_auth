...
usage: tigrbl-auth bootstrap [-h] [--env-file ENV_FILE] [--profile PROFILE]
                             ...
                             [--surface-set {admin-rest,admin-rpc,developer-api,diagnostics,my-account-api,platform-admin-api,public-api,public-rest,resource-validation-api,service-admin-api,tenant-admin-api}]
