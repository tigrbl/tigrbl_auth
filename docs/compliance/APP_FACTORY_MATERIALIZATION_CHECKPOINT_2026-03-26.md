# App factory materialization App-Factory Materialization Checkpoint — 2026-03-26

## Scope

This checkpoint addresses the App factory materialization closeout task:

> Make the ASGI application factory materialize in a real clean room.

The retained target for this target is the application factory at:
...
## What is complete for App factory materialization

The repository no longer fails App factory materialization immediately on the earlier hard blockers:
...
## What is still blocking full App factory materialization closeout

App factory materialization's stated exit criterion is:
...
4. the baseline runtime surface probe still fails on `/.well-known/oauth-protected-resource`, which is a Runtime HTTP surface/runtime-surface blocker even though the application factory itself now materializes.

## Current truthful status

- App factory materialization code-level blocker removal: **substantially complete**
- App factory materialization certification-grade matrix evidence: **not complete**
