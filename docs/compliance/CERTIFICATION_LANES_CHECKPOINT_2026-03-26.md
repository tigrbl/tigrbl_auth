# Certification lanes Certification-Lane Checkpoint — 2026-03-26

## Scope of this checkpoint

This checkpoint advances **Certification lanes: run the full in-scope certification lane matrix and fix whatever fails**.
...
- `docs/compliance/CERTIFICATION_LANES_CHECKPOINT_2026-03-26.md`
...
This is a **truthful Certification lanes checkpoint**.

It goes materially beyond the previous checkpoint by converting Certification lanes from **0 / 15** in-scope lane evidence to **5 / 15** in-scope lane evidence, fixing a real RFC 9396 core-lane defect, and keeping the repository’s generated contract / CLI artifacts synchronized. It still does **not** complete Certification lanes certification because the supported `py3.10` and `py3.12` certification-lane slices are not executed in this container.
