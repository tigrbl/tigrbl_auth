...
| RFC 7515 | tier 3 / evidenced-release-gated | pkgs/10-concrete/tigrbl-jws-concrete/src/tigrbl_jws_concrete<br>pkgs/20-providers/tigrbl-jose-cryptography-provider/src/tigrbl_jose_cryptography_provider | current: ∅<br>target: ∅ | conformance, unit | compliance/evidence/tier3/jose/ | none |
| RFC 7516 | tier 3 / evidenced-release-gated | pkgs/10-concrete/tigrbl-jwe-concrete/src/tigrbl_jwe_concrete<br>pkgs/20-providers/tigrbl-jose-cryptography-provider/src/tigrbl_jose_cryptography_provider | current: ∅<br>target: ∅ | conformance, unit | compliance/evidence/tier3/jwe/ | none |
...
| RFC 7519 | tier 3 / evidenced-release-gated | pkgs/10-concrete/tigrbl-jwt-concrete/src/tigrbl_jwt_concrete<br>pkgs/50-protocols/tigrbl-auth-protocol-jwt/src/tigrbl_auth_protocol_jwt | current: ∅<br>target: ∅ | conformance, unit | compliance/evidence/tier3/jwt/ | none |
...
| OIDC Core 1.0 | tier 3 / evidenced-release-gated | pkgs/50-protocols/tigrbl-auth-protocol-oidc/src/tigrbl_auth_protocol_oidc/standards/core.py<br>pkgs/50-protocols/tigrbl-auth-protocol-oidc/src/tigrbl_auth_protocol_oidc/id_token_profile.py | current: ∅<br>target: ∅ | conformance, unit, integration | compliance/evidence/tier3/oidc-core/ | none |
...
| OpenRPC 1.4.x admin/control-plane contract | tier 3 / implementation-backed-generated-from-rpc-registry | pkgs/60-runtime/tigrbl-identity-cli/src/tigrbl_identity_cli/cli/artifacts/_schemas.py | current: /rpc<br>target: /rpc | e2e, unit | compliance/evidence/tier3/contracts/openrpc/ | none |
...
| WebAuthn Level 2 relying-party implementation | extension-quarantine | Implementation is tested internally but no external FIDO conformance or certification claim is made. |
| FIDO2 server implementation profile | extension-quarantine | Profile mapping is implemented but external certification evidence is not yet attached. |
