...
| Credentials | Credentials package covers API keys, auth adapters, session services, and token lifecycle helpers. | [`tigrbl-authn-credentials` README](../pkgs/40-capabilities/tigrbl-authn-credentials/README.md) | Secret verification and key lifecycle should stay below frontdoor APIs. |
