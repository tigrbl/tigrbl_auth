...
The sample consumer package under `pkgs/110-examples/acme-notes-cli/` shows how a different Python package can expose a `login` command and use that flow for CLI authentication.
