...
|---|---|---|---|
| `public-uix` | tenant human user | login and end-user auth experience | current `pkgs/105-ui/public-uix` |
| `platform-admin-uix` | platform superuser | deployment-wide control-plane administration | split from current `pkgs/105-ui/admin-uix` |
| `tenant-admin-uix` | tenant admin | tenant-scoped administration | split from current `pkgs/105-ui/admin-uix` |
...
| Current repo basis | `pkgs/105-ui/public-uix/App.tsx`, discovery service, nginx allowlist |
...
| Current repo basis | `pkgs/105-ui/admin-uix` auth shell plus tenant and identity management slices |
...
|---|---|---|
| `pkgs/105-ui/public-uix` | `public-uix` | preserve as the end-user auth UIX |
