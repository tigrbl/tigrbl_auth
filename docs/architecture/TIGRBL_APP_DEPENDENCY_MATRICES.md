...
| `tigrbl-auth-public-portal` | `pkgs/105-ui/public-uix` | Tenant human-user public auth UX |
| `tigrbl-auth-platform-admin-console` | split from `pkgs/105-ui/admin-uix` | Platform-wide tenant and authority administration |
| `tigrbl-auth-tenant-admin-console` | split from `pkgs/105-ui/admin-uix` | Tenant-scoped identity, key, and local configuration administration |
...
| Dependency class | Dependencies |
|---|---|
| Runtime package dependencies | future dedicated portal UIX, plus existing backend support from `tigrbl-auth-protocol-oauth`, `tigrbl-identity-admin`, `tigrbl-identity-contracts`, `tigrbl-authz-policy`; existing partial frontend basis in `pkgs/105-ui/admin-uix/components/ClientManagement.tsx` |
...
| `tigrbl-auth-public-portal` | `pkgs/105-ui/public-uix` | tenant-branded composition and deployment wiring |
| `tigrbl-auth-platform-admin-console` | platform subset of `pkgs/105-ui/admin-uix` | explicit split from tenant-admin concerns |
| `tigrbl-auth-tenant-admin-console` | tenant subset of `pkgs/105-ui/admin-uix` | explicit split from platform-admin concerns |
