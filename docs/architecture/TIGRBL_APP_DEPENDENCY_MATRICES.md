...
| `tigrbl-auth-public-portal` | `apps/public-uix` | Tenant human-user public auth UX |
| `tigrbl-auth-platform-admin-console` | split from `apps/admin-uix` | Platform-wide tenant and authority administration |
| `tigrbl-auth-tenant-admin-console` | split from `apps/admin-uix` | Tenant-scoped identity, key, and local configuration administration |
...
| `tigrbl-auth-public-portal` | `apps/public-uix` | tenant-branded composition and deployment wiring |
| `tigrbl-auth-platform-admin-console` | platform subset of `apps/admin-uix` | explicit split from tenant-admin concerns |
| `tigrbl-auth-tenant-admin-console` | tenant subset of `apps/admin-uix` | explicit split from platform-admin concerns |
