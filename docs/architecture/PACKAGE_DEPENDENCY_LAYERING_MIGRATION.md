...
| Downstream frontend | `apps/*-uix`, `apps/rp`, `packages/uix-core` | May consume API contracts, discovery metadata, generated clients, and browser-safe UIX packages. Must not import Python `tigrbl_auth` modules. |
