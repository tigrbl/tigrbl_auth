...
|---|---|---|
| `public-uix` | `apps/public-uix` | Tenant human-user authentication and consent UX |
| `platform-admin-uix` | split from `apps/admin-uix` | Platform superuser administration UX |
| `tenant-admin-uix` | split from `apps/admin-uix` | Tenant-scoped administration UX |
...
|---|---|---|
| `public-uix` | `apps/public-uix` | tenant-branded composition and deployment wiring only |
| `platform-admin-uix` | platform subset of `apps/admin-uix` | explicit removal of tenant-local workflows and a dedicated platform nav/state model |
| `tenant-admin-uix` | tenant subset of `apps/admin-uix` | explicit removal of platform-global workflows and tenant-local client/policy completion |
