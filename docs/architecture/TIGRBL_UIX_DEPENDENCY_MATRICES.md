...
|---|---|---|
| `public-uix` | `pkgs/95-ui/public-uix` | Tenant human-user authentication and consent UX |
| `platform-admin-uix` | split from `pkgs/95-ui/admin-uix` | Platform superuser administration UX |
| `tenant-admin-uix` | split from `pkgs/95-ui/admin-uix` | Tenant-scoped administration UX |
...
|---|---|---|
| `public-uix` | `pkgs/95-ui/public-uix` | tenant-branded composition and deployment wiring only |
| `platform-admin-uix` | platform subset of `pkgs/95-ui/admin-uix` | explicit removal of tenant-local workflows and a dedicated platform nav/state model |
| `tenant-admin-uix` | tenant subset of `pkgs/95-ui/admin-uix` | explicit removal of platform-global workflows and tenant-local client/policy completion |
