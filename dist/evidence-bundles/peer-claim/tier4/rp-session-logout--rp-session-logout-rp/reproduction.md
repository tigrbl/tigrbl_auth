...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/rp-session-logout`.
2. Verify the counterpart metadata for `rp-session-logout-rp` and inspect the preserved artifacts.
