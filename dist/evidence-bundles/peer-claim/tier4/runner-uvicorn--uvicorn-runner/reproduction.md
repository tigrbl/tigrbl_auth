...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/runner-uvicorn`.
2. Verify the counterpart metadata for `uvicorn-runner` and inspect the preserved artifacts.
