...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/resource-server`.
2. Verify the counterpart metadata for `resource-server` and inspect the preserved artifacts.
