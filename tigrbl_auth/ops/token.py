...
_ensure_split("tigrbl_auth_protocol_oauth", "tigrbl-auth-protocol-oauth")
_spec = _find_spec("tigrbl_auth_protocol_oauth.ops.token")
if _spec is None or _spec.origin is None:
    raise ModuleNotFoundError("tigrbl_auth_protocol_oauth.ops.token")
__file__ = _spec.origin
__package__ = "tigrbl_auth_protocol_oauth.ops"
__spec__ = _spec
