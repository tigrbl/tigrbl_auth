...
This module is the product-facing bridge between deployment resolution and the
strategic security certification helpers.  It keeps metadata generation tied to
the same capability registry used for route composition.
"""
