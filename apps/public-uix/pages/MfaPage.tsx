    ...
    <div className="flex-grow flex items-center justify-center p-6 bg-slate-50">
      <div className="w-full max-w-md space-y-8 animate-in zoom-in-95 duration-500">
        ...
        <div className="text-center">
          <p className="text-xs text-slate-400 bg-slate-100 py-2 px-4 rounded-full inline-block">
            Debug hint: Use <span className="font-mono font-bold text-slate-600">123456</span> to pass
          </p>
        </div>
      </div>
    </div>
