...
def run_example() -> tuple[str, ...]:
    wit = {"iss": "https://issuer", "sub": "spiffe://example.org/workload", "cnf": {"jkt": "key"}, "exp": 2, "iat": 1}
    validate_wit({"typ": "wit+jwt", "alg": "ES256"}, wit)
    validate_wit_svid({"typ": "wit+jwt", "alg": "ES256", "kid": "wit-key"}, wit, proof_verified=True)
    validate_wpt({"typ": "wpt+jwt", "alg": "ES256"}, {"aud": "service", "exp": 2, "jti": "proof", "wth": "wit-hash"}, expected_audience="service", expected_wit_hash="wit-hash")
