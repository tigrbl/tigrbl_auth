...
class AdministrativeResourceCapability(Capability):
    def __init__(
        self,
        ...
        super().__init__(
            CapabilityDefinition(
                capability_id="administrative-resource.lifecycle",
                version="1.0",
            ),
            operations={
...
AdminControlPlane = AdministrativeResourceCapability
...
__all__ = [
    ...
    "AdminAuditOperation",
    "AdminControlPlane",
    "AdministrativeResourceCapability",
