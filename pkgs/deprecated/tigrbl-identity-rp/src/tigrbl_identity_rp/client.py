"""Deprecated compatibility module for `tigrbl_auth_protocol_rp.client`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_rp.client"
_CANONICAL_MODULE = "tigrbl_auth_protocol_rp.client"
