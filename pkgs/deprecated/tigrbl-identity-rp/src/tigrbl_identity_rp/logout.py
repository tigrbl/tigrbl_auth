"""Deprecated compatibility module for `tigrbl_auth_protocol_rp.logout`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_rp.logout"
_CANONICAL_MODULE = "tigrbl_auth_protocol_rp.logout"
