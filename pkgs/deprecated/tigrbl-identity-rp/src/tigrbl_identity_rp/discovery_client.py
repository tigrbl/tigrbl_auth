"""Deprecated compatibility module for `tigrbl_auth_protocol_rp.discovery_client`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_rp.discovery_client"
_CANONICAL_MODULE = "tigrbl_auth_protocol_rp.discovery_client"
