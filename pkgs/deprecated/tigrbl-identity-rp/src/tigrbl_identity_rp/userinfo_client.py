"""Deprecated compatibility module for `tigrbl_auth_protocol_rp.userinfo_client`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_rp.userinfo_client"
_CANONICAL_MODULE = "tigrbl_auth_protocol_rp.userinfo_client"
