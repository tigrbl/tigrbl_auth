"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.provider`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.provider"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.provider"
