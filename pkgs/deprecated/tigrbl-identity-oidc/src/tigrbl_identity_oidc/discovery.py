"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.discovery`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.discovery"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.discovery"
