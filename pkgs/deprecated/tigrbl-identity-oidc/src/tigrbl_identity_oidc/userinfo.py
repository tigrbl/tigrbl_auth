"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.userinfo`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.userinfo"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.userinfo"
