"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.userinfo`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.userinfo"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.userinfo"
