"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.core`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.core"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.core"
