"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.rp_initiated_logout`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.rp_initiated_logout"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.rp_initiated_logout"
