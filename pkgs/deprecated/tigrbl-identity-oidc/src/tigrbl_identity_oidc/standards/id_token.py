"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.id_token`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.id_token"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.id_token"
