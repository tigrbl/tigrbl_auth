"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.session_mgmt`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.session_mgmt"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.session_mgmt"
