"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.standards.discovery`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.standards.discovery"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.standards.discovery"
