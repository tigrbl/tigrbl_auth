"""Deprecated compatibility module for `tigrbl_auth_protocol_oidc.router`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oidc.router"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oidc.router"
