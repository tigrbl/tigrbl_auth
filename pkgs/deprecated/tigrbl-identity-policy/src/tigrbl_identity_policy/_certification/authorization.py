"""Deprecated compatibility module for `tigrbl_authz_policy._certification.authorization`."""
...
_CANONICAL_MODULE = "tigrbl_authz_policy._certification.authorization"
