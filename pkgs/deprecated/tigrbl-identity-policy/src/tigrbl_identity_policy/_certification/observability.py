"""Deprecated compatibility module for `tigrbl_auth_release_certification.certification.observability`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._certification.observability"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.certification.observability"
