"""Deprecated compatibility module for `tigrbl_authz_policy._certification.observability`."""
...
_CANONICAL_MODULE = "tigrbl_authz_policy._certification.observability"
