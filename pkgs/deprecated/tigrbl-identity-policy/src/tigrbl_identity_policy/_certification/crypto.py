"""Deprecated compatibility module for `tigrbl_auth_release_certification.certification.crypto`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._certification.crypto"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.certification.crypto"
