"""Deprecated compatibility module for `tigrbl_auth_release_certification.certification.base`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._certification.base"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.certification.base"
