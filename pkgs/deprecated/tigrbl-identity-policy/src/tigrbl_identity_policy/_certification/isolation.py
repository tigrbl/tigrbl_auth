"""Deprecated compatibility module for `tigrbl_auth_release_certification.certification.isolation`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._certification.isolation"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.certification.isolation"
