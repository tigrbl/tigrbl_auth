"""Deprecated compatibility module for `tigrbl_authz_policy.delegation_lifecycle`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.delegation_lifecycle"
_CANONICAL_MODULE = "tigrbl_authz_policy.delegation_lifecycle"
