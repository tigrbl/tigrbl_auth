"""Deprecated compatibility module for `tigrbl_authz_policy._control_plane.part_02`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._control_plane.part_02"
_CANONICAL_MODULE = "tigrbl_authz_policy._control_plane.part_02"
