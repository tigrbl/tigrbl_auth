"""Deprecated compatibility module for `tigrbl_authz_policy.provenance`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.provenance"
_CANONICAL_MODULE = "tigrbl_authz_policy.provenance"
