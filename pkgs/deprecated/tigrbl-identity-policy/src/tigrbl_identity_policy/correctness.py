"""Deprecated compatibility module for `tigrbl_authz_policy.correctness`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.correctness"
_CANONICAL_MODULE = "tigrbl_authz_policy.correctness"
