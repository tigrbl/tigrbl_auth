"""Deprecated compatibility module for `tigrbl_authz_policy._governance_extension.part_03`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._governance_extension.part_03"
_CANONICAL_MODULE = "tigrbl_authz_policy._governance_extension.part_03"
