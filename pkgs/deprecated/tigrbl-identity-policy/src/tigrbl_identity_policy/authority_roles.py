"""Deprecated compatibility module for `tigrbl_authz_policy.authority_roles`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.authority_roles"
_CANONICAL_MODULE = "tigrbl_authz_policy.authority_roles"
