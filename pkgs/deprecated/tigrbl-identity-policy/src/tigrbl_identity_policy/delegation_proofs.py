"""Deprecated compatibility module for `tigrbl_authz_policy.delegation_proofs`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.delegation_proofs"
_CANONICAL_MODULE = "tigrbl_authz_policy.delegation_proofs"
