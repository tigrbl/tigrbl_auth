"""Deprecated compatibility module for `tigrbl_authz_policy.authority_graph`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.authority_graph"
_CANONICAL_MODULE = "tigrbl_authz_policy.authority_graph"
