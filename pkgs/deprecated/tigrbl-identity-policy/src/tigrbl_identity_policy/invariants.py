"""Deprecated compatibility module for `tigrbl_authz_policy_concrete.invariant_registry`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.invariants"
_CANONICAL_MODULE = "tigrbl_authz_policy_concrete.invariant_registry"
