"""Deprecated compatibility module for `tigrbl_authz_policy._admin_gate.helpers`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._admin_gate.helpers"
_CANONICAL_MODULE = "tigrbl_authz_policy._admin_gate.helpers"
