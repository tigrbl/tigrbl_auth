"""Deprecated compatibility module for `tigrbl_authz_policy._admin_gate`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._admin_gate"
_CANONICAL_MODULE = "tigrbl_authz_policy._admin_gate"
