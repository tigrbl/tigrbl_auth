"""Deprecated compatibility module for `tigrbl_auth_release_certification.release_posture.transport`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._release_posture.transport"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.release_posture.transport"
