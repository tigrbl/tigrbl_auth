"""Deprecated compatibility module for `tigrbl_auth_release_certification.release_posture.models`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy._release_posture.models"
_CANONICAL_MODULE = "tigrbl_auth_release_certification.release_posture.models"
