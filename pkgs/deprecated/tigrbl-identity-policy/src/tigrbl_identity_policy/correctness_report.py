"""Deprecated compatibility module for `tigrbl_authz_policy.correctness_report`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.correctness_report"
_CANONICAL_MODULE = "tigrbl_authz_policy.correctness_report"
