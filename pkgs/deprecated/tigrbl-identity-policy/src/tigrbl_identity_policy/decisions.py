"""Deprecated compatibility module for `tigrbl_authz_policy.decisions`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_policy.decisions"
_CANONICAL_MODULE = "tigrbl_authz_policy.decisions"
