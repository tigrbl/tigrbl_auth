"""Deprecated compatibility module for `tigrbl_authz_resource_server.verifier`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_resource_server.verifier"
_CANONICAL_MODULE = "tigrbl_authz_resource_server.verifier"
