"""Deprecated compatibility module for `tigrbl_authz_resource_server.contracts`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_resource_server.contracts"
_CANONICAL_MODULE = "tigrbl_authz_resource_server.contracts"
