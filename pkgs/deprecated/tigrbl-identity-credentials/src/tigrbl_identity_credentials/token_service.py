"""Deprecated compatibility module for `tigrbl_authn_credentials.token_service`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.token_service"
_CANONICAL_MODULE = "tigrbl_authn_credentials.token_service"
