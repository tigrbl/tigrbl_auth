"""Deprecated compatibility module for `tigrbl_authn_credentials.authenticate`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.authenticate"
_CANONICAL_MODULE = "tigrbl_authn_credentials.authenticate"
