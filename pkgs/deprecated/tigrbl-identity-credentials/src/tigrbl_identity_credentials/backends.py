"""Deprecated compatibility module for `tigrbl_authn_credentials.backends`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.backends"
_CANONICAL_MODULE = "tigrbl_authn_credentials.backends"
