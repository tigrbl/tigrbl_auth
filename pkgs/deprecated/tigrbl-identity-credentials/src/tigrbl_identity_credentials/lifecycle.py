"""Deprecated compatibility module for `tigrbl_authn_credentials.lifecycle`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.lifecycle"
_CANONICAL_MODULE = "tigrbl_authn_credentials.lifecycle"
