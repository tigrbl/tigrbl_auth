"""Deprecated compatibility module for `tigrbl_identity_storage_runtime.resource_service`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.operator_service"
_CANONICAL_MODULE = "tigrbl_identity_storage_runtime.resource_service"
