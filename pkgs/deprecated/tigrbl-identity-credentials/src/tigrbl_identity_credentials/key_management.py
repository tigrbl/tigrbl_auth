"""Deprecated compatibility module for `tigrbl_authn_credentials.key_management`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.key_management"
_CANONICAL_MODULE = "tigrbl_authn_credentials.key_management"
