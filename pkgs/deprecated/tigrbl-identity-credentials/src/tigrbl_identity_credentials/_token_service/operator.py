"""Deprecated compatibility module for `tigrbl_authn_credentials._token_service.operator`."""
...
_CANONICAL_MODULE = "tigrbl_authn_credentials._token_service.operator"
