"""Deprecated compatibility module for `tigrbl_authn_credentials._token_service.coder`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials._token_service.coder"
_CANONICAL_MODULE = "tigrbl_authn_credentials._token_service.coder"
