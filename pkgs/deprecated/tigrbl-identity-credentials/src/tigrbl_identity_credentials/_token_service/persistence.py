"""Deprecated compatibility module for `tigrbl_identity_storage_runtime.token_persistence`."""
...
_CANONICAL_MODULE = "tigrbl_identity_storage_runtime.token_persistence"
