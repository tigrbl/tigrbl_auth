"""Deprecated compatibility module for `tigrbl_identity_storage.tables.token_record._ops`."""
...
_CANONICAL_MODULE = "tigrbl_identity_storage.tables.token_record._ops"
