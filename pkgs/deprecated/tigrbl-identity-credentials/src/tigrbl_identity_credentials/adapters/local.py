"""Deprecated compatibility module for `tigrbl_identity_server.security.authn_adapters.local`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.adapters.local"
_CANONICAL_MODULE = "tigrbl_identity_server.security.authn_adapters.local"
