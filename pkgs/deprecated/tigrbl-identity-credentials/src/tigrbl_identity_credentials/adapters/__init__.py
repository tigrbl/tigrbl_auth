"""Deprecated compatibility module for `tigrbl_authn_credentials.adapters`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.adapters"
_CANONICAL_MODULE = "tigrbl_authn_credentials.adapters"
