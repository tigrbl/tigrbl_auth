"""Deprecated compatibility module for `tigrbl_identity_server.security.authn_adapters.context`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.auth_context"
_CANONICAL_MODULE = "tigrbl_identity_server.security.authn_adapters.context"
