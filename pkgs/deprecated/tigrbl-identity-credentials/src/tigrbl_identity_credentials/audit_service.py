"""Deprecated compatibility module for `tigrbl_authn_credentials.audit_service`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.audit_service"
_CANONICAL_MODULE = "tigrbl_authn_credentials.audit_service"
