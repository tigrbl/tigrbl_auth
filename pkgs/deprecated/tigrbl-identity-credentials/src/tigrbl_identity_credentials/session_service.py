"""Deprecated compatibility module for `tigrbl_identity_storage_runtime.session_service`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_credentials.session_service"
_CANONICAL_MODULE = "tigrbl_identity_storage_runtime.session_service"
