...
> Deprecated compatibility package: new credential facade imports should use `tigrbl-credentials` and `tigrbl_credentials`. This package remains available for one migration window.
...
- [Package source](https://github.com/tigrbl/tigrbl_auth/tree/master/pkgs/deprecated/tigrbl-identity-credentials)
