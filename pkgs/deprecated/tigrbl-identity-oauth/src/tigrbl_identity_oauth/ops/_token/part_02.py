"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.ops._token.part_02`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.ops._token.part_02"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.ops._token.part_02"
