"""Deprecated compatibility module for `tigrbl_identity_storage.tables.token_record._route`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.ops._token"
_CANONICAL_MODULE = "tigrbl_identity_storage.tables.token_record._route"
