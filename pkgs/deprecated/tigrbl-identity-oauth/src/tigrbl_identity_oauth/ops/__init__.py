"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.ops`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.ops"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.ops"
