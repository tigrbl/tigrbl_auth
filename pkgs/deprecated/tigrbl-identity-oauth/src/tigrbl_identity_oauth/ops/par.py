"""Deprecated compatibility module for `tigrbl_identity_storage.tables.pushed_authorization_request._op`."""
...
_CANONICAL_MODULE = "tigrbl_identity_storage.tables.pushed_authorization_request._op"
