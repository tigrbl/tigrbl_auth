"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.ops.device_authorization`."""
...
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.ops.device_authorization"
