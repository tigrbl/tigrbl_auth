"""Deprecated compatibility module for `tigrbl_identity_storage_runtime.device_authorization`."""
...
_CANONICAL_MODULE = "tigrbl_identity_storage_runtime.device_authorization"
