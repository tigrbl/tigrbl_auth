"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.ops._register.part_01`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.ops._register.part_01"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.ops._register.part_01"
