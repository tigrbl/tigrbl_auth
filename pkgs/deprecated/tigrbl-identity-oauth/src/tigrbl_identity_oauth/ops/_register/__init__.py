"""Deprecated compatibility module for `tigrbl_identity_storage_runtime.client_registration`."""
...
_CANONICAL_MODULE = "tigrbl_identity_storage_runtime.client_registration"
