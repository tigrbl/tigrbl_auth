"""Deprecated compatibility module for `tigrbl_identity_storage.tables._oauth_authorize`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.ops.authorize"
_CANONICAL_MODULE = "tigrbl_identity_storage.tables._oauth_authorize"
