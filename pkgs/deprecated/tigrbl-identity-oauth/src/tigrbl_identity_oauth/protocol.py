"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.protocol`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.protocol"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.protocol"
