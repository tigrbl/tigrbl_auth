"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.issuer_identification`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.issuer_identification"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.issuer_identification"
