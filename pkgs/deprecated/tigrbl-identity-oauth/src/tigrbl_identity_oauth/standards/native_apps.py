"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.native_apps`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.native_apps"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.native_apps"
