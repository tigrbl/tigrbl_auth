"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards._dpop.part_02`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards._dpop.part_02"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards._dpop.part_02"
