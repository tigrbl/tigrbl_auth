"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards._dpop`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards._dpop"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards._dpop"
