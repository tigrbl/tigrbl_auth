"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.rich_authorization_requests`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc9396"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.rich_authorization_requests"
