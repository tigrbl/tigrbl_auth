"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.jwt_access_tokens`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.jwt_access_tokens"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.jwt_access_tokens"
