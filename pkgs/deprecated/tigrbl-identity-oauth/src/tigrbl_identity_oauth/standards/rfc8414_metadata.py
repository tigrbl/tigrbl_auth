"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.rfc8414_metadata`."""
...
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.rfc8414_metadata"
