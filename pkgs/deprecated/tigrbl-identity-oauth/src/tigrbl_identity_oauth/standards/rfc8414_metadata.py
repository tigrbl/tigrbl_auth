"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.authorization_server_metadata`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc8414_metadata"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.authorization_server_metadata"
