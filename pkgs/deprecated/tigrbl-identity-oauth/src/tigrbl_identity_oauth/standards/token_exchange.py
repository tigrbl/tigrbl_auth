"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.token_exchange`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.token_exchange"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.token_exchange"
