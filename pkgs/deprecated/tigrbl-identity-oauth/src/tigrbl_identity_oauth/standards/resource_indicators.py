"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.resource_indicators`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.resource_indicators"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.resource_indicators"
