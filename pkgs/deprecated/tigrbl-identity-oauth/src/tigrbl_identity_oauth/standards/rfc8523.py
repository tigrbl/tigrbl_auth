"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.legacy_jwt_client_assertions`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc8523"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.legacy_jwt_client_assertions"
