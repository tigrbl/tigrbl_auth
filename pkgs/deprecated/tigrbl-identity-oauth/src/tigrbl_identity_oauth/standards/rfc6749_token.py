"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.token_endpoint`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc6749_token"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.token_endpoint"
