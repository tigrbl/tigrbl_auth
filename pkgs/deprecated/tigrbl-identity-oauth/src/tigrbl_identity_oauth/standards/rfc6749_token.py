"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.rfc6749_token`."""
...
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.rfc6749_token"
