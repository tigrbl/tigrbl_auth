"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.rfc9449_dpop`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc9449_dpop"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.rfc9449_dpop"
