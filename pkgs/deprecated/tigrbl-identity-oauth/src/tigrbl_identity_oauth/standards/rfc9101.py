"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.jwt_secured_authorization_requests`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc9101"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.jwt_secured_authorization_requests"
