"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.authorization_framework`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc6749"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.authorization_framework"
