"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.oauth_security_bcp`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.rfc9700"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.oauth_security_bcp"
