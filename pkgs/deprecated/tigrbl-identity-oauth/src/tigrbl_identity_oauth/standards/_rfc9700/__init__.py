"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards._rfc9700`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards._rfc9700"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards._rfc9700"
