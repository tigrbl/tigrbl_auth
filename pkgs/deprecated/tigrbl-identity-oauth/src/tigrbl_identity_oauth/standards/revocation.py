"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.revocation`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.revocation"
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.revocation"
