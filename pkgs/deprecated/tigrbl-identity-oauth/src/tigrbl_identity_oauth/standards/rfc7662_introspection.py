"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.introspection`."""
...
_CANONICAL_MODULE = "tigrbl_auth_protocol_oauth.standards.introspection"
