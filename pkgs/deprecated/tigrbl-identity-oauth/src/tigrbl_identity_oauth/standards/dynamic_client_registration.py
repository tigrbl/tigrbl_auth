"""Deprecated compatibility module for `tigrbl_auth_protocol_oauth.standards.dynamic_client_registration`."""
...
_DEPRECATED_MODULE = "tigrbl_identity_oauth.standards.dynamic_client_registration"
