...
PUBLIC_CAPABILITIES: Final[tuple[dict[str, Any], ...]] = (
    {
        ...
        "tags": ("auth",),
        "router_ref": "tigrbl_identity_server.rest.routers.login:api",
    ...
    },
    {
        ...
        "tags": ("oauth2", "oidc"),
        "router_ref": "tigrbl_identity_server.rest.routers.authorize:api",
        "targets": (
            "RFC 6749",
            "OIDC Core 1.0",
            "RFC 8252",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "router_ref": "tigrbl_identity_server.rest.routers.token:api",
    ...
    },
    {
        ...
        "tags": ("oidc",),
        "publisher_ref": "tigrbl_auth_protocol_oidc.standards.userinfo:include_oidc_userinfo",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "publisher_ref": "tigrbl_auth_protocol_oauth.standards.introspection:include_introspection_endpoint",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "router_ref": "tigrbl_identity_server.rest.routers.register:api",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "router_ref": "tigrbl_identity_server.rest.routers.revoke:api",
        "targets": ("RFC 7009",),
        "contract_visible": True,
        "discovery_visible": True,
    },
    {
        ...
        "tags": ("oidc",),
        "router_ref": "tigrbl_identity_server.rest.routers.logout:api",
        "targets": (
            "RFC 6265",
            "OIDC Session Management",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "router_ref": "tigrbl_identity_server.rest.routers.device_authorization:api",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "router_ref": "tigrbl_identity_server.rest.routers.par:api",
    ...
    },
    {
        ...
        "tags": ("my-account",),
        "router_ref": "tigrbl_identity_server.rest.routers.my_account:api",
    ...
    },
    {
        ...
        "tags": ("oauth2",),
        "publisher_ref": "tigrbl_auth_protocol_oauth.standards.token_exchange:include_token_exchange_endpoint",
    ...
    },
    {
        ...
        "tags": (".well-known",),
        "publisher_ref": "tigrbl_auth_protocol_oidc.standards.discovery:include_openid_configuration",
    ...
    },
    {
        ...
        "tags": (".well-known",),
        "publisher_ref": "tigrbl_auth_protocol_oauth.standards.rfc8414:include_rfc8414",
    ...
    },
    {
        ...
        "tags": (".well-known",),
        "publisher_ref": "tigrbl_auth_protocol_oauth.standards.rfc9728:include_rfc9728",
    ...
    },
    {
        ...
        "tags": (".well-known",),
        "publisher_ref": "tigrbl_auth_protocol_oidc.standards.discovery:include_jwks",
