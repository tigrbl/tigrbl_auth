"""ASGI entrypoint for the platform admin Tigrbl Auth backend application."""
...
from tigrbl_auth_backend_app_platform_admin.identities import router as identity_router
from tigrbl_auth_backend_app_platform_admin.realms import router as realm_router
from tigrbl_auth_backend_app_platform_admin.tenants import router as tenant_router
...
def build_app(settings_obj: object | None = None) -> "TigrblApp":
    ...
    app = build_product_app(
        PRODUCT_SURFACE, settings_obj, contract=PLATFORM_ADMIN_BACKEND_APP_CONTRACT
    )
