...
```python
from tigrbl_auth_backend_app_developer import app, build_app
```

## Local dev deployment

```powershell
docker compose -f docker/docker-compose.developer-app.yml up -d --build
```
