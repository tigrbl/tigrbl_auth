"""OpenAPI affordances for the My Account backend app."""
...
def patch_my_account_openapi(app: object) -> object:
    ...
    def my_account_openapi() -> dict[str, Any]:
        ...
        openapi["title"] = "tigrbl-auth-backend-app-my-account"
    ...
    if isinstance(routes, list):
        ...
        for route in routes:
            path = str(
                getattr(route, "path_template", None) or getattr(route, "path", "")
            )
