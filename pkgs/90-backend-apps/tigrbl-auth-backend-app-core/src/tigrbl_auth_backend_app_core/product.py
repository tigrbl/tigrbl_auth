"""Product-specific backend application assembly."""
...
def validate_backend_app_contract(contract: object, deployment: object) -> None:
...
def build_product_app(
    ...
    *,
    ...
    """Build the shared ASGI app constrained to one declared product surface."""
    ...
    if contract is not None:
        validate_backend_app_contract(contract, deployment)
    return build_app(settings_obj, deployment=deployment)


__all__ = ["build_product_app", "validate_backend_app_contract"]
