"""Concrete `assertions` subject-information field."""
...
class AssertionsClaim(ClaimBase):
    claim_name = "assertions"
    ...
    def validate_value(cls, value):
        if (
            ...
            raise ValueError("assertions must contain formatted assertion objects")


__all__ = ["AssertionsClaim"]
