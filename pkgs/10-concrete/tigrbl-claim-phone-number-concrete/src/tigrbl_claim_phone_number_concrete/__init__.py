...
class PhoneNumberClaim(ClaimBase):
    ...
    def validate_value(cls, value):
        if not (isinstance(value, str) and value.startswith('+') and value[1:].isdigit()):
            raise ValueError("phone_number has an invalid OIDC claim value")


__all__ = ["PhoneNumberClaim"]
