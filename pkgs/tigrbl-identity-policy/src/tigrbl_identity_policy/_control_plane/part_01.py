...
PHASE3_ADMIN_POLICY_FEATURES: tuple[AdminPolicyBoundaryFeature, ...] = (
...
def phase3_admin_policy_boundary_manifest() -> dict[str, dict[str, Any]]:
    return {
        feature.feature_id: {
        ...
        for feature in PHASE3_ADMIN_POLICY_FEATURES
    }


def phase3_admin_policy_boundary_integrity() -> dict[str, Any]:
