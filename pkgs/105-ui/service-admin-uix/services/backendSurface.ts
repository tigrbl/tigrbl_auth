export const BACKEND_APP = "tigrbl-auth-backend-app-service-admin";
export const BACKEND_APP_BASE_URL_ENV = "VITE_TIGRBL_AUTH_SERVICE_ADMIN_BACKEND_APP_BASE_URL";
export const BACKEND_APP_BASE_URL = (import.meta.env.VITE_TIGRBL_AUTH_SERVICE_ADMIN_BACKEND_APP_BASE_URL ?? "http://localhost:8018").replace(/\/+$/, "");
