...
def _resource_catalog(repo_root: Path, resource: str) -> dict[str, Any]:
    catalog: dict[str, dict[str, Any]] = {
        ...
        "identity": {"modules": ["tigrbl_auth/tables/user.py", "tigrbl_auth/tables/service_identity.py", "tigrbl_auth/tables/credential_api_key.py", "tigrbl_auth/tables/credential_service_key.py"], "routes": ["/login"], "targets": ["OIDC Core 1.0"], "verbs": ["create", "update", "delete", "get", "list", "set-password", "lock", "unlock"]},
