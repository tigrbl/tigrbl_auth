...
tigrbl-identity-admin contains runtime composition for storage-backed administration capabilities for a Tigrbl identity deployment. It supplies tenant, user, client, key, session, token, consent, audit, profile, and governance integrations to upper-layer control-plane use cases.
...
- Admin runtime helpers and advanced identity integrations compose storage-owned tables below the application capability layer.
...
- [Package source](https://github.com/tigrbl/tigrbl_auth/tree/master/pkgs/60-runtime/tigrbl-identity-admin)
