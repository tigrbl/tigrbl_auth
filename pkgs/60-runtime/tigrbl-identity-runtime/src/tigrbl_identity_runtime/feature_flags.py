...
FEATURE_FLAG_GROUPS: Final[dict[str, dict[str, object]]] = {
    ...
    "extension_quarantine": {
        ...
        "flags": {
            ...
            "enable_webauthn": "W3C WebAuthn relying-party ceremonies",
            "enable_fido2_server_profile": "FIDO2 server requirement profile",
            "enable_fido_metadata_service": "FIDO Metadata Service trust and status data",
