...
def validate_cwt_svid_extension(protected_headers: Mapping[object, object], claims: Mapping[int, object], *, proof_verified: bool) -> None:
    ...
    if not proof_verified: raise ValueError("CWT-SVID extension requires verified proof of possession")