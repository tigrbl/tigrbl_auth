...
def validate_wit_svid(headers: Mapping[str, object], claims: Mapping[str, object], *, proof_verified: bool) -> None:
    ...
    if not proof_verified: raise ValueError("WIT-SVID requires verified proof of possession")