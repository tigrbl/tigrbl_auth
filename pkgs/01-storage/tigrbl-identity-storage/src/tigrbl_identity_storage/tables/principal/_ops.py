...
from ._table import Principal
from typing import Any

async def _lookup(cls, db: Any, *, principal_id: str) -> "Principal | None":
    return await first_record(cls, db, {"id": principal_id})

@_table_op_ctx(bind=Principal, alias="disable", target="custom", rest=False)
