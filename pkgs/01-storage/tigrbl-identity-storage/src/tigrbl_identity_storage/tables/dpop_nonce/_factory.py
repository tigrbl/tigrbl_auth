"""Factory helpers for DPoP nonce table variants."""
...
from ._table import DpopNonce


def _derive_table(model: Type[DpopNonce], *, class_name: str, spec: type) -> Type[DpopNonce]:
    return type(
        class_name,
        (spec, model),
        {
