"""Durable federated identity provider records."""
...
class IdentityProvider(RestOltpTable, GUIDPk, Timestamped):
    __tablename__ = "identity_providers"
    __table_args__ = ({"schema": "authn"},)

    provider_id: Mapped[str] = acol(storage=S(String(255), nullable=False, unique=True, index=True))
