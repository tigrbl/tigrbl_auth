...
@_table_op_ctx(bind=AuthSession, alias="revoke_for_user", target="custom", rest=False)
...
@_table_op_ctx(bind=AuthSession, alias="revoke_all_for_user", target="custom", rest=False)
...
@_table_op_ctx(bind=AuthSession, alias="touch", target="custom", rest=False)
