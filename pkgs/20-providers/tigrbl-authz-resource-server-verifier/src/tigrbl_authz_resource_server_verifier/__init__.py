...
from tigrbl_security_token_introspection_client import IntrospectionClient
from tigrbl_security_token_jwks_cache import JWKSCache
    ...
    def verify_token(
        ...
        *,
        ...
        return self.verify_claims(
            self.introspection_client.introspect_claims(token),
            requirement,
            dpop=dpop,
            mtls=mtls,
        )
