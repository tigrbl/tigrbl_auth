"""Representation-neutral identity assurance contracts.

Models the final OpenID Identity Assurance Schema Definition 1.0 without
coupling the payload to an ID Token, UserInfo response, or credential format.
"""
