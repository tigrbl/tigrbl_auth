...
_LAZY_EXPORTS = {
    ...
    "AuthorizationServerConfiguration": ".authorization_server",
    "AuthorizationServerMetadataPublisherPort": ".authorization_server",
    "AuthorizationServerPatch": ".authorization_server",
    "AuthorizationServerResolverPort": ".authorization_server",
    "ConsentGrantRequest": ".consent",
    "ConsentRecord": ".consent",
    "ConsentRevocationRequest": ".consent",
    ...
    "TokenExchangeContext": ".exchange",
    "TokenExchangeResponse": ".exchange",
    "TokenExchangeSenderConstraint": ".exchange",
    "TokenExchangeServicePort": ".exchange",
    "TokenRecord": ".refresh",
    "TokenRevocationPort": ".revocation",
    "TokenRevocationRequest": ".revocation",
    "TokenRevocationResult": ".revocation",
}
