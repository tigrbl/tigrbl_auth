...
def revoke_all_sessions_for_context(
    context: OperationContext,
    *,
    status_filter: str | None = None,
    filter_expr: str | None = None,
...
def revoke_all_tokens_for_context(
    context: OperationContext,
    *,
    status_filter: str | None = None,
    filter_expr: str | None = None,
...
def exchange_token_for_context(
    context: OperationContext,
    *,
...
def observe_token_response(
    ...
    *,
    ...
    if access_token:
        observed["access_token_id"] = _observe_token_like(
            repo_root,
            token=access_token,
            kind="access",
            actor=actor,
    ...
    if refresh_token:
        observed["refresh_token_id"] = _observe_token_like(
            repo_root,
            token=refresh_token,
            kind="refresh",
            actor=actor,
    ...
    if id_token:
        observed["id_token_id"] = _observe_token_like(
            repo_root,
            token=id_token,
            kind="id",
            actor=actor,
...
def observe_device_authorization_response(
    ...
    *,
    ...
    record_surface_event(
        repo_root,
        event_type="device_authorization",
        target_type="token",
        target_id=target_id,
        outcome="ok",
        tenant_id=tenant,
...
def observe_par_response(
    ...
    *,
    ...
    record_surface_event(
        repo_root,
        event_type="par",
        target_type="pushed_authorization_request",
        target_id=target_id,
        outcome="ok",
        tenant_id=tenant,
        actor_user_id=actor,
