...
class ScimSchemaRecord(Base, GUIDPk, Timestamped):
    ...
    @classmethod
    async def list_for_resource_kind(cls, db: Any, *, resource_kind: str) -> list["ScimSchemaRecord"]:
        return await list_records(cls, db, {"resource_kind": resource_kind})
