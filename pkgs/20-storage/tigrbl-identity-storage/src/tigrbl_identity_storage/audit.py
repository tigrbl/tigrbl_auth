...
from .operator_store import ArtifactResult, display_path, latest_event, validate_checksum, write_structured
from .resource_service import list_activity, list_audit_rows, list_transactions
...
def record_surface_event(
    ...
    *,
    ...
    from .operator_store import OperationContext, append_jsonl, audit_log_path, build_audit_entry, utc_now
