"""ASGI entrypoint for the public Tigrbl Auth API surface."""
...
from tigrbl_auth_api_public.openapi import patch_public_openapi
...
def build_app(settings_obj: object | None = None) -> "TigrblApp":
    ...
    return patch_public_openapi(build_product_app(PRODUCT_SURFACE, settings_obj))
