"""ASGI entrypoint for the My Account Tigrbl Auth API surface."""
...
from tigrbl_auth_api_my_account.routes import api as account_api
            ...
            await send(
                {
                    ...
                    + [
                        (b"access-control-allow-methods", b"GET,PATCH,POST,DELETE,OPTIONS"),
                        (
