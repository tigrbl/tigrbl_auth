...
from tigrbl_identity_oauth.ops.device_authorization import device_authorization_request
...
async def device_authorization(request, db=Depends(get_db)):
    ...
    from tigrbl_identity_credentials.session_service import observe_device_authorization_response
