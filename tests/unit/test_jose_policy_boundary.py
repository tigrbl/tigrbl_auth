...
def test_jose_policy_t2_public_boundary_has_no_forbidden_imports() -> None:
    ...
    files = [
        ...
        root / "tigrbl-identity-policy/src/tigrbl_identity_policy/__init__.py",
        root / "tigrbl-identity-policy/src/tigrbl_identity_policy/decisions.py",
    ]
    forbidden = {"tigrbl_auth", "tigrbl_identity_oauth", "tigrbl_identity_oidc", "tigrbl_identity_server"}
