...
from tigrbl_identity_storage import token_service as token_persistence
...
async def test_issue_persisted_token_pair_decodes_minted_tokens_without_revocation(monkeypatch):
    ...
    monkeypatch.setattr(
        "tigrbl_identity_storage.tables.token_record._lifecycle.upsert_token_record_async",
