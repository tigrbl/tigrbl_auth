...
def test_phase5_governance_extension_boundary_t0_inventory_tracks_all_features():
    manifest = phase5_governance_extension_boundary_manifest()
    integrity = phase5_governance_extension_boundary_integrity()
...
def test_phase5_governance_extension_boundary_t1_composes_sdk_plugins_scim_entitlements_and_reviews():
...
def test_phase5_governance_extension_boundary_t2_fails_closed_for_drift_and_unsafe_operations():
    catalog = _sdk_catalog()
    plugins = _plugins()
    scim = _scim()
    entitlements, assignment_id = _entitlements()
