...
def test_server_assembly_materializes_database_and_processor_scoped_capabilities() -> None:
    assembly = build_server_runtime_assembly(settings)
    ...
    materialized = {
        ...
        "identity-admin.tenants": registry.materialize(
            "identity-admin.tenants", db
        ),
