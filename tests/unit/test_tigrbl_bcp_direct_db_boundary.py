...
SEMANTIC_FACADE_PATHS = [
    ...
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/assurance.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/authority.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/control_plane.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/delegation.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/governance_extension.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/abac.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/delegated_admin.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/policy_engine.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/rbac.py",
    ROOT / "pkgs/60-runtime/tigrbl-authz-policy/src/tigrbl_authz_policy/service_identity_registry.py",
