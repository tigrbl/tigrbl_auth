...
MIGRATED_RELEASE_PATHS = [
    ...
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/authorization.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/auth_session/_ops.py",
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/account_surface.py",
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/auth_flows.py",
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/authz_surface.py",
    ...
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/userinfo.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/revoked_token/_ops.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/token_record/_ops/__init__.py",
...
SEMANTIC_FACADE_PATHS = [
    ...
    ROOT / "pkgs/20-providers/tigrbl-authz-policy-admin-gate/src/tigrbl_authz_policy_admin_gate/gate.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/assurance.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/authority.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/control_plane.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/delegation.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/governance_extension.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/abac.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/delegated_admin.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/policy_engine.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/rbac.py",
    ROOT / "pkgs/20-providers/tigrbl-authz-policy/src/tigrbl_authz_policy/service_identity_registry.py",
    ...
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/operator_store.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/_sync.py",
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/_operator_store/__init__.py",
    ...
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/resource_service.py",
    ROOT / "pkgs/30-storage-runtime/tigrbl-identity-storage-runtime/src/tigrbl_identity_storage_runtime/_resource_service/__init__.py",
...
PERSISTENCE_HELPER_PATHS = [
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/token_record/_ops/_records.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/auth_session/_ops.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/logout_state/_ops.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/client_registration/_ops.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/consent/_ops.py",
    ROOT / "pkgs/01-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/tables/audit_event/_table.py",
]
