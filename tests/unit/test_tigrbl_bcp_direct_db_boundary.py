...
MIGRATED_RELEASE_PATHS = [
    ...
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/authorize.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/device_authorization.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/par.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/register.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/registration_endpoint.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/registration_runtime.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/token.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/token_endpoint.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oauth/src/tigrbl_auth_protocol_oauth/ops/token_runtime.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oidc/src/tigrbl_auth_protocol_oidc/router.py",
    ...
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/ops/login.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/rest/routers/admin_auth.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/rest/routers/admin_identities.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/rest/routers/admin_realms.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/rest/routers/admin_tenants.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/rest/routers/my_account.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/routers/auth_flows.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/routers/authz/oidc.py",
...
PERSISTENCE_HELPER_PATHS = [
    ROOT / "pkgs/20-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/_persistence/token_records.py",
    ROOT / "pkgs/20-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/_persistence/sessions.py",
    ROOT / "pkgs/20-storage/tigrbl-identity-storage/src/tigrbl_identity_storage/_persistence/registrations_audit.py",
]
...
ASYNC_REQUEST_TOKEN_PATHS = [
    ...
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oidc/src/tigrbl_auth_protocol_oidc/userinfo.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-oidc/src/tigrbl_auth_protocol_oidc/standards/userinfo.py",
    ROOT / "pkgs/40-protocols/tigrbl-auth-protocol-rp/src/tigrbl_auth_protocol_rp/userinfo_client.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/security/auth.py",
    ROOT / "pkgs/50-runtime/tigrbl-identity-server/src/tigrbl_identity_server/security/deps.py",
]
