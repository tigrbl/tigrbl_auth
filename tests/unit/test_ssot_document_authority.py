...
TEST_ID = "tst:tests-unit-test-ssot-document-authority-py"
ADR_ID = "adr:1031"
SPEC_ID = "spc:1052"
...
def test_ssot_document_authority_artifacts_are_registered_and_linked() -> None:
    ...
    assert test_row["path"] == "tests/unit/test_ssot_document_authority.py"
