...
PACKAGE_ROOTS = [
    ...
    "tigrbl_security_token_verification",
...
DIST_TO_IMPORT_ROOT = {
    ...
    "tigrbl-security-token-verification": "tigrbl_security_token_verification",
...
def test_oidc_backchannel_logout_uses_split_replay_store() -> None:
    ...
    replay_store = importlib.import_module("tigrbl_identity_concrete.replay_store")
