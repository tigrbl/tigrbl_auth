...
PACKAGE_ROOTS = [
    ...
    "tigrbl_security_dpop_cnf_binding_validator",
    "tigrbl_security_mtls_cnf_binding_validator",
    "tigrbl_security_sender_constraint_validator",
    "tigrbl_security_token_introspection_client",
    "tigrbl_security_token_jwks_cache",
    ...
    "tigrbl_authority_graph_concrete",
    ...
    "tigrbl_trust_federation_graph_concrete",
...
DIST_TO_IMPORT_ROOT = {
    ...
    "tigrbl-authority-graph-concrete": "tigrbl_authority_graph_concrete",
    ...
    "tigrbl-identity-admin-federation-registry": "tigrbl_identity_admin_federation_registry",
    "tigrbl-identity-admin-policy-registry": "tigrbl_identity_admin_policy_registry",
    "tigrbl-identity-admin-relationship-graph": "tigrbl_identity_admin_relationship_graph",
    "tigrbl-identity-admin-trust-federation-graph": "tigrbl_identity_admin_trust_federation_graph",
    "tigrbl-trust-federation-graph-concrete": "tigrbl_trust_federation_graph_concrete",
