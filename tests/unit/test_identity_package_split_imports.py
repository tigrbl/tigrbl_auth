...
PACKAGE_ROOTS = [
    ...
    "tigrbl_authz_policy_abac_administrator",
    "tigrbl_authz_policy_authority_derivation_graph",
    "tigrbl_authz_policy_delegated_administrator",
    "tigrbl_authz_policy_decision_engine",
    "tigrbl_authz_policy_engine",
    "tigrbl_authz_policy_invariant_registry",
    "tigrbl_authz_policy_rbac_administrator",
    "tigrbl_authz_policy_service_identity_registry",
