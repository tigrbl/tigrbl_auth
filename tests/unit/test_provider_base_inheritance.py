...
PROVIDER_BASES = {
    ...
    "tigrbl_security_auth_context_acr_basic.BasicAcrEvaluator": "tigrbl_authentication_context_bases.AcrEvaluatorBase",
    "tigrbl_security_auth_context_amr_basic.BasicAmrEvaluator": "tigrbl_authentication_context_bases.AmrEvaluatorBase",
    ...
    "tigrbl_security_subject_pairwise_provider.PairwiseSubjectProvider": "tigrbl_identity_model_bases.SubjectIdentifierStrategyBase",
