...
FACADE_MODULES = {
    ...
    "tigrbl_auth.oidc_userinfo": "tigrbl_identity_server.userinfo_runtime",
    ...
    "tigrbl_auth.standards.oauth2.token_exchange": "tigrbl_identity_server.token_exchange_runtime",
    "tigrbl_auth.standards.oidc.userinfo": "tigrbl_identity_server.userinfo_runtime",
    ...
    assert set(metadata["project"]["dependencies"]).issuperset(
        {
            ...
            "tigrbl-authz-policy-obligations-concrete==0.4.0.dev2",
            "tigrbl-authz-policy-rules-concrete==0.4.0.dev2",
            "tigrbl-security-authorization-provenance-builder==0.1.0",
