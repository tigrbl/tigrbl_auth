...
PACKAGE_DIR = ROOT / "pkgs" / "95-ui" / "rp"
...
def test_typescript_rp_t0_package_scaffold_and_workspace_membership() -> None:
    ...
    assert "pkgs/95-ui/rp" in root_manifest["workspaces"]
    ...
    assert manifest["repository"]["directory"] == "pkgs/95-ui/rp"
...
def test_typescript_rp_t2_npm_release_workflow_uses_provenance() -> None:
    ...
    assert '"pkgs/95-ui/rp"' in workflow_text
