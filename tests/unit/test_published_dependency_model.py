...
def test_pyproject_uses_published_pins_and_extras():
    ...
    assert "tigrbl-auth-protocol-oidc-backchannel-replay-store==0.4.0.dev2" in dependencies
    assert "tigrbl-authz-resource-server-dpop-cnf-binding-validator==0.4.0.dev2" in dependencies
    assert "tigrbl-authz-resource-server-introspection-client==0.4.0.dev2" in dependencies
    ...
    assert "tigrbl-identity-admin-auth-anomaly-detector==0.4.0.dev2" in dependencies
    ...
    auth_anomaly_detector_dependencies = set(_load_package_pyproject("tigrbl-identity-admin-auth-anomaly-detector")["project"]["dependencies"])
    ...
    introspection_client_dependencies = set(_load_package_pyproject("tigrbl-authz-resource-server-introspection-client")["project"]["dependencies"])
    ...
    resource_server_verifier_dependencies = set(_load_package_pyproject("tigrbl-authz-resource-server-verifier")["project"]["dependencies"])
    ...
    assert oidc_backchannel_replay_store_dependencies == set()
    ...
    assert "pqcrypto==0.4.0" not in auth_anomaly_detector_dependencies
    assert "tigrbl-identity-contracts==0.4.0.dev2" in auth_anomaly_detector_dependencies
    assert "tigrbl-identity-core==0.4.0.dev2" in auth_anomaly_detector_dependencies
    assert "tigrbl-identity-admin==0.4.0.dev2" not in auth_anomaly_detector_dependencies
    ...
    assert "tigrbl-identity-admin==0.4.0.dev2" not in policy_registry_dependencies
    assert "pqcrypto==0.4.0" not in relationship_graph_dependencies
    ...
    assert "pqcrypto==0.4.0" not in introspection_client_dependencies
    assert "tigrbl-identity-contracts==0.4.0.dev2" in introspection_client_dependencies
    assert "tigrbl-authz-resource-server==0.4.0.dev2" not in introspection_client_dependencies
    ...
    assert "pqcrypto==0.4.0" not in sender_constraint_validator_dependencies
    assert "tigrbl-authz-resource-server-dpop-cnf-binding-validator==0.4.0.dev2" in sender_constraint_validator_dependencies
    ...
    assert "pqcrypto==0.4.0" not in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server-dpop-cnf-binding-validator==0.4.0.dev2" in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server-introspection-client==0.4.0.dev2" in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server-jwks-cache==0.4.0.dev2" in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server-mtls-cnf-binding-validator==0.4.0.dev2" in resource_server_verifier_dependencies
    assert "tigrbl-identity-contracts==0.4.0.dev2" in resource_server_verifier_dependencies
    assert "tigrbl-security-trust-contracts==0.1.0" in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server==0.4.0.dev2" not in resource_server_verifier_dependencies
    assert "tigrbl-authz-resource-server-dpop-cnf-binding-validator==0.4.0.dev2" in resource_server_dependencies
    assert "tigrbl-authz-resource-server-introspection-client==0.4.0.dev2" in resource_server_dependencies
