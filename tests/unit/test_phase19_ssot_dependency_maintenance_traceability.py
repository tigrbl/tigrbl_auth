...
TEST_ID = "tst:tests-unit-test-phase19-ssot-dependency-maintenance-traceability-py"
ADR_ID = "adr:1030"
SPEC_ID = "spc:1051"
PIN_TEST_ID = "tst:tests-unit-test-phase1-published-dependency-model-py"
...
def test_dependency_maintenance_artifacts_are_registered_and_linked() -> None:
    ...
    assert test_row["path"] == "tests/unit/test_phase19_ssot_dependency_maintenance_traceability.py"
