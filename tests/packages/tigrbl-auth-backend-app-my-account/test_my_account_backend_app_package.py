...
my_account_package = import_module("tigrbl_auth_backend_app_my_account")
PRODUCT_SURFACE = my_account_package.PRODUCT_SURFACE
MY_ACCOUNT_BACKEND_APP_CONTRACT = my_account_package.MY_ACCOUNT_BACKEND_APP_CONTRACT
...
def test_my_account_contract_matches_product_surface_registry() -> None:
    ...
    assert PRODUCT_SURFACE == "my-account-app"
    assert MY_ACCOUNT_BACKEND_APP_CONTRACT.product_surface == PRODUCT_SURFACE
    assert MY_ACCOUNT_BACKEND_APP_CONTRACT.intended_uix == "@tigrbl-auth/my-account-uix"
    ...
    for capability in MY_ACCOUNT_BACKEND_APP_CONTRACT.baseline_capabilities:
