...
async def client(monkeypatch):
    ...
    monkeypatch.setattr(
        "tigrbl_identity_storage.tables.token_record._ops.read_handler_record",
        AsyncMock(return_value=DummyClient()),
    )
    monkeypatch.setattr(
        "tigrbl_identity_storage.tables.token_record._ops.first_handler_record",
        AsyncMock(return_value=None),
    )
    monkeypatch.setattr(
        "tigrbl_identity_storage.tables.token_record._ops.issue_token_pair_records",
